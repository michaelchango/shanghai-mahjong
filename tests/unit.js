...
ok('清一色2勒子', r && r.type === '清一色' && r.lezi === 2 && r.base === 0, JSON.stringify(r));
r = ev([m(1),m(1),m(1),m(5),m(5),m(5),m(7),m(7),m(7),m(9),m(9),m(9),m(3),m(3)]);
ok('清碰4勒子', r && r.type === '清碰' && r.lezi === 4 && r.base === 0, JSON.stringify(r));
...
ok('混碰1番', r && r.type === '混碰' && r.base === 1, JSON.stringify(r));
r = ev([E,E,E,S,S,S,W,W,W,N,N,N,E,E]);
ok('风碰8勒子', r && r.type === '风碰' && r.lezi === 8 && r.base === 0, JSON.stringify(r));
r = ev([E,E,E,E,S,S,S,S,W,W,W,W,N,N]);
ok('风一色(乱风向)4勒子', r && r.type === '风一色' && r.lezi === 4 && r.base === 0, JSON.stringify(r));
...
pl = P({ hand: [m(1),m(1),m(1),m(2),m(2),m(2),m(3),m(3),m(3),m(4),m(4),m(4),m(5)], melds: [], knocked: true, menqing: true, flowers: [100], missHu: new Set() });
co = T.claimOptions(pl, m(5), 3, true);
